    ...
    if 'regcapdb' in visual_tools:
        ...
        for region in region_captions:
            ...
            region_evidence = {
                    ...
                    'counterfactual_prediction_entailment_conf': 0.0,
                    'relevance': 0.0,
                    'is_reliable': True if region_presence_confidence >= evidence_conf_threshold else False,
                    'is_relevant': False,
                }
            if region_presence_confidence >= evidence_conf_threshold:
...
def main():
    ...
    parser.add_argument("--experiments_dir", type=str, default='/net/nfs.cirrascale/mosaic/tejass/experiments/recoverr/recoverr_013024')
